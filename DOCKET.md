...
| UB-6 | WONTFIX | EVIDENCE.md figures verified against primary artifacts | symptom | - | - | filed 2026-08-03; closed 2026-08-04 -- the file was CUT, not verified. Operator call after review: the draft disclosed origin-system operational specifics (an internal tool name, lifetime item counts, concurrent-session counts, dated internal rulings) the README's stories do not need, and its remaining figures were candidates rather than counted. Nothing survives to verify. |
